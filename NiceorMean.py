...
#
# Author: Roman L. Paladiy
#
# Purpose: The Tech Academy - Python Course, creating my first program in python.
...
def score(nice,mean,name):
   ...
   if nice > 2: # if condition is valid, call win function passing in the variables so it can use them
       win(nice,mean,name)
   if mean > 2: # if condition is valid, call lose function passing the variables so it can use them
       lose(nice,mean,name)
